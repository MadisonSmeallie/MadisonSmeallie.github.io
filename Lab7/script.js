...
function validateSienaID(sienaID) {
    ...
    if (!sienaID.startsWith("90") || !/^\d{9}$/.test(sienaID)) {
        return "Invalid ID. Please use your Siena College ID starting with 90- and consists of nine digits";
    }
...
function validateForm() {
    ...
    const sienaIdValidationMessage = validateSienaID(sienaIDInput.value);
